    ...
    private class Square extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (logic.isOccupied() && (view == ViewMode.Master || logic.isGuessed())) {
                ...
                setBackground(getColorFromProbability(logic.getOccupiedProbability()));
            }
            if (logic.isGuessed()) {
            ...
            if (logic.isOccupied() && logic.getOccupant().ship.isSunk()) {
        ...
        private Color getColorFromProbability(double occupiedProbability) {
            return new Color(255, 255, 255 - (int) (255 * occupiedProbability));
        }
    }
